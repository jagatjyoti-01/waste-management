            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 w-full h-full ">
                ...
                <div className="hidden sm:block relative bg-green-600 bg-cover bg-center px-8 py-16 ">
                    ...
                    <div className="flex flex-col items-center justify-center h-full text-white  "  >
                        {isLogin ? (
                            ...
                            <>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4 ">Reducing E-Waste for a </h1>
                                <h2 className="text-2xl md:text-3xl md:pr-32 "> Greener Tomorrow</h2>
                            </>
                        )}
                    </div>
                    {/* Background shapes */}
                ...
                <div className="flex items-center justify-center py-16 ">
                    <div className="w-full max-w-md ">
                        <div className="flex justify-center mb-8 font-semibold gap-3 px-2">
                            <span 
